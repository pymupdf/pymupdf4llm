...
from train.infer.common_util import (get_boxes_transform, get_edge_by_directional_nn, get_edge_by_alignment, get_edge_by_knn,
...
def get_nn_input_from_datadict(data_dict, cfg, return_nn_index=False,
                               feature_extractor=None, edge_sampling='4D'):
    ...
    if edge_attr.shape[1] != edge_dim:
        raise Exception(f'edge_dim({edge_dim}) != edge_attr({edge_attr.shape[1]})')
